...
* 🎓 B.Voc Software Development Student at Delhi University (CGPA: 9.0/10)
* 💻 Frontend-focused MERN Stack Developer
* 🏆 Top 15 Shortlisted Team at HackFest 2.0
* 🌱 Currently improving React architecture, backend development, and system design fundamentals
* ⚡ Passionate about building products that solve real-world problems
* 🎯 Looking for opportunities to contribute, learn, and grow as a developer
...
### 🎥 Streamix – Video Sharing Platform
A full-stack video sharing platform built with MERN stack featuring authentication, uploads, and responsive UI.

**Tech Stack:** React, Node.js, Express, MongoDB, Tailwind, Cloudinary, Multer, JWT

🔗 Live: https://navyaekshan.netlify.app/  
🔗 Frontend: https://github.com/Apoorvabd/yoytube_frontened2.0  
🔗 Backend: https://github.com/Apoorvabd/youtube_backend  

---

### 🍔 Food Delivery Web App
Responsive food ordering platform with clean UI and reusable components.

**Tech Stack:** React, JavaScript, Tailwind CSS

🔗 Live: https://abd-food-web.netlify.app/  
🔗 Repo: https://github.com/Apoorvabd/Food-App  

---

## 🏆 Achievements

* 🥇 Top 15 HackFest 2.0 Finalist
* 🤖 Built AI-powered BRD Generator using Google Gemini API
* 🎖️ NCC Lance Corporal
* 👥 Former Deputy Coordinator, Educen Society
...
* Learn TypeScript + scalable frontend architecture
* Contribute to open source
* Secure Frontend / MERN Internship
...
💼 LinkedIn: https://www.linkedin.com/in/apoorv-chaturvedi-197409321/  
💻 GitHub: https://github.com/Apoorvabd  
